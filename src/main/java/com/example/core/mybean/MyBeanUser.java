...
public class MyBeanUser {
  ...
  public MyPrototypeBean getPrototypeBean() {
    // Spring will override this method to return a new instance of MyPrototypeBean each time it's
    // called
    return null;
  }
  ...
  public void doWork2() {
    ...
    // Since MySingletonBean is a singleton, the same instance is used each time the method is
    // called
