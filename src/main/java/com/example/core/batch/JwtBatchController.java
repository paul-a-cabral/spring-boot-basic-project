...
@ConditionalOnProperty(prefix = "app.security", name = "authentication", havingValue = AuthenticationMode.JWT_VALUE)
public class JwtBatchController {
  ...
  public JwtBatchController(@Qualifier("asyncJobLauncher") JobLauncher jobLauncher, Job importEmployeeJob,
