...
class BasicBatchControllerTest {
  ...
  void runEmployeeBatchImport_Success() throws Exception {
    ...
    mockMvc.perform(post("/api/batch/import-employees")
  ...
  private static final String SECRET_KEY = "YmFzZTY0LWVuY29kZWQtc3VwZXItc2VjcmV0LWtleS1mb3Itand0LXNhbXBsZS0yMDI2"; // Replace
                                                                                                                   // with
                                                                                                                   // your
                                                                                                                   // actual
                                                                                                                   // secret
